    ...
    <div>
         <div className='card w-md-50 mx-auto'>
            <div className='card-body p-4'>
                <div className='row '>
                    <div className='col-md-6 order-sm-1 text-center text-md-start col-margin' id='pageview-text'>
                        100k PAGEVIEWS
                    </div>
                ...
                <div className='row billing-row col-margin justify-content-center' id="billing-row">
